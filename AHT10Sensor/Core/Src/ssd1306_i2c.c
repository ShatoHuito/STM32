...
uint8_t temp_ssd1306[2] = {0,0};
uint8_t temp_char_ssd1306[7] = {0,0,0,0,0,0,0};



unsigned char LCD_X,LCD_Y;
unsigned char LCD_Buffer_ssd1306[0x0500] =
{
...
void OLED_print_pix(uint32_t x, uint32_t y)
{
	int ost;
	LCD_Goto(x, y / 8);
	ost = y % 8;
...
void OLED_print_circle(uint32_t x, uint32_t y, uint32_t rad)
{
	uint32_t i = 0; //x
	uint32_t j = 0; //j
    float dist;
